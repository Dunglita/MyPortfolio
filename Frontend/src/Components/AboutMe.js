  ...
  return (
    <>
      <div className="about-me" id="about-me">
        <img id="me-img" src={me} alt="Daniel Garcia Images" />
        <div id="right-content">
          ...
          <p>
            ...
            <br />
            <br />
            Actually I'm involved in the area of Web Developping using React and
            NodeJS, having special interest in Frontend and UX/UI desing. Also
            at the moment I'm learning Angular and doing a Java course.
            <br />
            <br />
